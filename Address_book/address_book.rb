...
class AddressBook 
    ...
    print_result("Name search results (#{search})", results) 

end
    def find_by_phone(number)
        results = []
        search = number.gsub("-", "")
        contacts.each do |contact|
        ...
        print_result("phone search results (#{search})", results) 
    ...
    def find_by_address(query)
      ...
      print_result("Addres search result#{search}", results)
    end
    def print_result(search, results)
            puts search
